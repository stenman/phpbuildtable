...
--
-- Table structure for table `agdq_big`
--

CREATE TABLE IF NOT EXISTS `agdq_big` (
...
--
-- Dumping data for table `agdq_big`
--

INSERT INTO `agdq_big` (`date_and_time`, `game`, `runner`, `estimate`, `comments`, `couch_commentators`, `prizes`) VALUES
